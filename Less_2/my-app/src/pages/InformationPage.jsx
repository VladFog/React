      ...
      <div className="contact">
        <div className="contact__container _container">
          <div className="contact__main">
            ...
            <div> EMAIL: company@youremail.com
            WEBSITE: www.yourwebsite.com</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="about__container _container">
          <div className="about__main">
            ...
            <div className="about__text">
              ...
              diam consequat maecenas. Turpis metus sit diam purus leo in varius ac quam. Nunc amet
              tristique volutpat adipiscing vulputate phasellus. Volutpat faucibus praesent ac
              lobortis aliquam dolor. <br />
              Diam feugiat are mattis metus, parturient ipsum id nibh tortor tincidunt. Quam facilisi nunc faucibus diam consequat maecenas lorem ipsum donec. Vitae faucibus diam consequat maecenas. Turpis metus sit diam purus leo in varius ac quam. Nunc amet tristique volutpat adipiscing vulputate phasellus diam consequat lorem ipsum estera maecenas.
            </div>
          </div>
        </div>
      </div>
